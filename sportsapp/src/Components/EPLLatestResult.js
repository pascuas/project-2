...
function EPLLatestResult(props) {
    ...
    let opponentFour = []
    let opponentFive = []
    for (let j=0; j < props.eplTeams.length; j++)
    if (props.eplTeams[j].strTeam === opponents[0]) {
        opponentOne = props.eplTeams[j]
    }
    for (let j=0; j < props.eplTeams.length; j++)
    if (props.eplTeams[j].strTeam === opponents[1]) {
        opponentTwo = props.eplTeams[j]
    } 
    for (let j=0; j < props.eplTeams.length; j++)
    if (props.eplTeams[j].strTeam === opponents[2]) {
        opponentThree = props.eplTeams[j]
    } 
    for (let j=0; j < props.eplTeams.length; j++)
    if (props.eplTeams[j].strTeam === opponents[3]) {
        opponentFour = props.eplTeams[j]
    } 
    for (let j=0; j < props.eplTeams.length; j++)
    if (props.eplTeams[j].strTeam === opponents[4]) {
        opponentFive = props.eplTeams[j]
    }
...
export default EPLLatestResult